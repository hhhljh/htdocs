function siteLoad(){
	...
	$("head").append('\
		...
		.layer{display:flex;left:0;right:0;top:0;bottom:0;position:fixed;background:rgba(0,0,0,.5);justify-content:center;align-items:center;z-index:100;}\
...
function layerOpen(){
	...
	<div class="layer" style="display:none;">\
		...
		<div class="desc">\
			<p>현재 이미지는 '+idx+'.jpg입니다.</p>\
			<p>현재 페이지 : '+idx+' /  총 페이지 :16</p>\
		</div>\
	</div>';
