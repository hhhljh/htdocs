                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="/share/in_list" class="active">내부공유 목록</a>
                                </li>
                                <li>
                        ...
                        <div class="panel-body">
                            ...
                            <div class="table-responsive">
                                ...
                                <?php foreach ($list as $data) { ?>
                                        <tr>
                                            <td class="center"><?php if($memberInfo->idx == $data->midx){ ?><input type="checkbox" name="idx[]" class="chk" value="<?php echo $data->idx ?>" /><?php } ?></td>
                                            <td><a href="/share/inShare/<?php echo $data->idx ?>"><?php echo $data->file_name ?></a></td>
                                            ...
                                            <td class="left">
                                               <a href="/share/inShare/<?php echo $data->idx ?>">  
                                                <?php
                                                    echo $_SERVER['REQUEST_SCHEME']."://"; 
                                                    echo $_SERVER['HTTP_HOST'];
                                                    echo "/share/inShare/".$data->idx; 
                                                ?>
                                               </a>
                                            </td>
                                        </tr>
