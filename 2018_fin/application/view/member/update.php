                    ...
                    <div class="panel-body">
                        <form role="form" method="post">
                            ...
                            <fieldset>
                                ...
                                <div class="form-group">
                                    <input class="form-control" placeholder="아이디" name="id" type="text" value="<?php echo $data->id ?>" autofocus>
                                </div>
                                <div class="form-group">
                                    <input class="form-control" placeholder="암호" name="pw" type="password">
                                </div>
                                <div class="form-group">
                                    <input class="form-control" placeholder="회원구분(관리자,일반회원)" name="level" type="text" value="<?php echo $data->level == 10 ? "관리자" : "일반회원" ?>" autofocus>
                                </div>
                                <div class="checkbox">
                                    <label>
